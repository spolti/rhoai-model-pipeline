...
def infer(endpoint, protocol, port=80):
    ...
    print(f"Using {protocol} protocol to infer the model {model_name} at {endpoint}:{port}")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--endpoint', default='http://localhost:8080', type=str, help='Model endpoint, provide the '
